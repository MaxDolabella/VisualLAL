...
namespace Maxsys.VisualLAL
{
	...
	/// </remarks>
	public partial class VisualLALToolboxHelper : VisualLALToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new VisualLALToolboxHelper.
		/// </summary>
		public VisualLALToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class VisualLALToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify VisualLAL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "VisualLAL.1.0";
		...
		/// <summary>
		/// Constructs a new VisualLALToolboxHelperBase.
		/// </summary>
		protected VisualLALToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Maxsys.VisualLAL.VisualLALDomainModel.SingletonResourceManager.GetString("VisualLALToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Maxsys.VisualLAL.VisualLALDomainModel));
