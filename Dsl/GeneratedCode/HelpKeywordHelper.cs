...
namespace Maxsys.VisualLAL
{
	...
	/// </remarks>
	public partial class VisualLALHelpKeywordHelper : VisualLALHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new VisualLALHelpKeywordHelper.
		/// </summary>
		protected VisualLALHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the VisualLALHelpKeywordHelper.
		/// </summary>
		public static VisualLALHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class VisualLALHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new VisualLALHelpKeywordHelperBase.
		/// </summary>
		protected VisualLALHelpKeywordHelperBase()
			: base() { }
