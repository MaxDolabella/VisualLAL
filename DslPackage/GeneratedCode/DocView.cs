...
namespace Maxsys.VisualLAL
{
	...
	/// </summary>
	internal partial class VisualLALDocView : VisualLALDocViewBase
	{
		/// <summary>
		/// Constructs a new VisualLALDocView.
		/// </summary>
		public VisualLALDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class VisualLALDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new VisualLALDocView.
		/// </summary>
		protected VisualLALDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			VisualLALDocDataBase docData = this.DocData as VisualLALDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for VisualLALDocViewBase should be an VisualLALDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Maxsys.VisualLAL.VisualLALDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Maxsys.VisualLAL.VisualLALDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Maxsys.VisualLAL.VisualLALToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Maxsys.VisualLAL.VisualLALToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.VisualLALDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Maxsys.VisualLAL.VisualLALHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Maxsys.VisualLAL.VisualLALHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Maxsys.VisualLAL.VisualLALHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
