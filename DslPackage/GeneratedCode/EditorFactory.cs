...
namespace Maxsys.VisualLAL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.VisualLALEditorFactoryId)]
	internal partial class VisualLALEditorFactory : VisualLALEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new VisualLALEditorFactory.
		/// </summary>
		public VisualLALEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class VisualLALEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected VisualLALEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new VisualLALDocData(this.ServiceProvider, typeof(VisualLALEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new VisualLALDocView(docData, this.ServiceProvider);
		}
	}
}
