...
namespace Maxsys.VisualLAL
{
	...
	internal abstract class VisualLALCommandSetBase : DslShell::CommandSet
	{
		...
		{
			if (this.CurrentVisualLALDocData != null && this.CurrentVisualLALDocData.Store != null)
			{
				this.CurrentVisualLALDocData.ValidationController.Validate(this.CurrentVisualLALDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentVisualLALDocData != null && this.CurrentVisualLALDocData.Store != null)
			{
				...
				this.CurrentVisualLALDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
